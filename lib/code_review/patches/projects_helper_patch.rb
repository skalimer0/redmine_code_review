...
unless ProjectsHelper.included_modules.include?(CodeReview::Patches::ProjectsHelperPatch)
  ProjectsHelper.send(:include, CodeReview::Patches::ProjectsHelperPatch)
end
